...
- **Frontend** (React)
- **Backend** (Express), Database-MySQL.
...
2. Open Xampp server, start Apache, MySQL.
3. Create a database with name "store" in phpmyadmin. Import the sql file from sql folder.
...
### 🖥️ 5. Run the Frontend (React App)
